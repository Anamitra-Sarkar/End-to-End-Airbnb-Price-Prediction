...
// Removed unused icons: Globe, Menu, UserCircle
            ...
            <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-6 absolute left-1/2 transform -translate-x-1/2">
                    <button
                        ...
                        className={`text-sm px-4 py-2 rounded-full transition-colors ${activeTab === "Homes" || !activeTab ? "font-bold text-black bg-gray-100" : "font-medium text-gray-500 hover:bg-gray-100"}`}
                    >
                        Homes
                    </button>
                    <button
                        onClick={() => handleTabChange("Experiences")}
                        className={`text-sm px-4 py-2 rounded-full transition-colors ${activeTab === "Experiences" ? "font-bold text-black bg-gray-100" : "font-medium text-gray-500 hover:bg-gray-100"}`}
                    >
                        Experiences
                    </button>
                </div>
                ...
                <div className="flex items-center gap-4">
                    {/* User Avatar - Simulating Logged In State */}
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-rose-500 to-orange-500 p-0.5 shadow-lg cursor-pointer hover:scale-110 transition-transform">
                        <div className="w-full h-full rounded-full bg-white flex items-center justify-center overflow-hidden">
                            {/* Placeholder for real avatar, using an icon for now or a generic user image */}
